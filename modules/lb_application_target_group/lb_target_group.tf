...
resource "aws_lb_target_group" "application_lb_target_group" {
  ...
  stickiness {
    type            = "${var.aws_lb_target_group_variables["stickiness_type"]}"
    cookie_duration = "${var.aws_lb_target_group_variables["stickiness_cookie_duration"]}"
    enabled         = "${var.aws_lb_target_group_variables["stickiness_enabled"]}"
  }
