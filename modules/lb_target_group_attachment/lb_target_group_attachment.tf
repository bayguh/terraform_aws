variable "lb_target_group_attachment_variables" {
    type        = "map"
...
resource "aws_lb_target_group_attachment" "lb_target_group_attachment" {
  count            = "${var.lb_target_group_attachment_variables["count"]}"
  target_group_arn = "${var.lb_target_group_attachment_variables["target_group_arn"]}"
  target_id        = "${element(var.target_ids, count.index)}"
  port             = "${var.lb_target_group_attachment_variables["port"]}"
